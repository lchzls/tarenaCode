...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            //删除
            function deleteFee(x) {
                var r = window.confirm("确定要删除此资费吗？");
                if(r){
                	 location.href='deleteCost.do?id='+x;
                }else{
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    ...
                    <!-- 浏览器打开查询资费页面，然后再访问资费增加页面，所以是站在浏览器的角度来看到相对路径，
                                                                是查询和打开增加页面的相对。对于浏览器而言，查询资费的路径是/netctoss/findCost.do，而不是find.jsp。
                                                                打开增加资费页面的路径是/netctoss/toAddCost.do -->
                    ...
                    <table id="datalist">
                        ...
                        <tr>
                            ...
                            <td>                                
                                ...
                                <!-- onclick="location.href='deleteCost.do?id=${c.costId}';" -->
                            </td>
                        </tr>
                        </c:forEach>   
                    </table>
